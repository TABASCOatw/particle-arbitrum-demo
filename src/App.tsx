...
const App = () => {
  ...
  const smartAccount = new SmartAccount(provider, {
    ...
    aaOptions: {
      simple: [{ chainId: ArbitrumSepolia.id, version: '1.0.0' }],
    },
  });
  ...
  const executeUserOp = async () => {
    ...
    notification.success({
      ...
      description: (
        <div>
          Transaction Hash: <a href={`https://sepolia.arbiscan.io/tx/${txReceipt.transactionHash}`} target="_blank" rel="noopener noreferrer">{txReceipt.transactionHash}</a>
        </div>
      )
    });
  };
  ...
  return (
    <div className="App">
      <div className="logo-section">
        ...
        <img src="https://i.imgur.com/QEE0IAx.png" alt="Logo 2" className="logo logo-big" />
      </div>
      {!userInfo ? (
